...
ports.forEach(() => {            //for.Each loops over ports array
...
app.listen(port, () => {   //one way to access ports array listed above is to change "port" to ports[0]
    console.log(`Example app listening at http://localhost:${port}`)
})

servers.forEach(server => {           //ports check mapping over ports array and then popping out last item in array.
